<?php
        ...
        $searchResult = $site->searchLands($searchWord,'Vacant');
            ...
            ?>
                <div class="row tada hover-shadow-2">
                  ...
                  <div class="col-2 text-right" style="padding-top: 4%">
                    <a href="<?php echo $all->txnLink ?>" target="_blank" data-toggle="tooltip" title="View on Blockchain" class="iconbox text-warning">
